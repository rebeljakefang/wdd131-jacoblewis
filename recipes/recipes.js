const recipes = [
  ...
  },
  {
    ...
    prepTime: "30 min",
    recipeInstructions: [
      "Combine the flour, butter, sugar and eggs in a bowl and beat with a whisk until you have a smooth dough. Transfer the batter to a 26 cm (10 inch) spring-form lined with parchment paper at the bottom and greased on the side. Smooth with a spoon or spatula and set aside.",
      "In the same bowl combine sugar, butter and flour. Using your hands mix all the ingredients together until small crumbles start to form. Set aside. Preheat the oven to 180°C (356°F), with both top and bottom heat.",
      "In a small pot combine milk, sugar and cornstarch. Stir constantly until it starts to bubble and has thickened. Remove from heat and cool for 2 to 3 minutes. Scatter gooseberries over the base. Whisk sour cream into the vanilla cream, spread it over the gooseberries, add the crumble, and bake for 45 minutes or until lightly golden brown."
    ],
...
function renderRecipes(recipeList) {
  if (recipeList.length === 0) {
    recipeContainer.innerHTML = `
      <p class="no-results">No recipes matched your search. Try another word.</p>
    `;
    return;
  }
...
searchForm.addEventListener("submit", (event) => {
  ...
  renderRecipes(searchRecipes(searchInput.value));
});
